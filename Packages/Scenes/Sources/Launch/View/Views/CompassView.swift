...
final class CompassView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        // Draw degree numbers and compass directions
        ...
        // Draw compass lines
        drawCenterLines(context: context, center: center, radius: radius)
...
private extension CompassView {
    func drawDegreeNumbers(context: CGContext, center: CGPoint, radius: CGFloat, headingRadians: CGFloat) {
        ...
        for i in stride(from: 0, to: 360, by: 30) {
            ...
            drawText(context: context, text: degreeString, at: angle, center: center, radius: radius)
        }
    }
    ...
    func drawCompassDirections(context: CGContext, center: CGPoint, radius: CGFloat, headingRadians: CGFloat) {
        ...
        for (i, direction) in directions.enumerated() {
            ...
            drawText(context: context, text: attributedString, at: angle, center: center, radius: directionRadius)
        }
    }
    ...
    func drawDegreeMarks(context: CGContext, center: CGPoint, radius: CGFloat, headingRadians: CGFloat) {
        for i in stride(from: 0, to: 360, by: 5) {
            ...
            let startRadius = i % 30 == 0 ? radius - 30 : radius - 25
    ...
    func drawCenterLines(context: CGContext, center: CGPoint, radius: CGFloat) {
    ...
    func drawText(context: CGContext, text: NSAttributedString, at angle: CGFloat, center: CGPoint, radius: CGFloat) {
    ...
    func drawLine(context: CGContext, from angle: CGFloat, startRadius: CGFloat, endRadius: CGFloat, center: CGPoint, isMajor: Bool = true) {
        ...
        context.setStrokeColor(isMajor ? UIColor.lightGray.cgColor : UIColor.lightGray.withAlphaComponent(0.7).cgColor)
